document.addEventListener('DOMContentLoaded', function() {
    ...
    function applyLanguage(lang) {
        ...
        if (lang === 'en') {
            titleEl.textContent = 'A Time for Yourself – Yoga and Thai Massage in Montbrun-les-Bains';
            ...
            titleEl.textContent = 'Un temps pour soi-même – Yoga et massage thaï à Montbrun-les-Bains';
            document.querySelector('meta[name="description"]').setAttribute('content', 
    ...
    document.querySelectorAll('.service-card, .yoga-type, .pricing-card, .stage-card, .location-card, .info-card').forEach(el => {
        el.style.opacity = '0';
